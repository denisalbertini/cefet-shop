...
export const MENSAGEM_ERRO = {
  ...
  ITEM_PARA_LISTAR: {
    QUANTIDADE:
      'O atributo quantidade de ItemParaListar deve ser do tipo number.',
    SUBTOTAL: 'O atributo subTotal de ItemParaListar deve ser do tipo string.',
    PRODUTO_ID:
      'O atributo produtoId de ItemParaListar deve ser do tipo string.',
    PRODUTO_FOTO:
      'O atributo produtoFoto de ItemParaListar deve ser do tipo string.',
    PRODUTO_NOME:
      'O atributo produtoNome de ItemParaListar deve ser do tipo string.',
    PRODUTO_ESTOQUE:
      'O atributo produtoEstoque de ItemParaListar deve ser do tipo number.',
  },
