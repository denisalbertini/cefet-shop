...
export class VisaoCarrinhosEmHtml implements VisaoCarrinhos {
    ...
    exibir(carrinho: CarrinhoParaExibir): void {
        ...
        for (const item of carrinho.itens) {
            ...
            quantidade.min = '1';
            quantidade.max = item.produtoEstoque < 10 ? item.produtoEstoque.toString() : '10';
            ...
            quantidade.addEventListener('change', (event) => {
                ...
                this.controladoraCarrinhos.alterarQuantidadeItem(item.produtoId, novaQuantidade);
            });
    ...
    alterarQuantidadeItem(carrinho: CarrinhoAtualizado): void {
        ...
        (li?.querySelector('.sub-total') as HTMLSpanElement).textContent = carrinho.subTotal;
