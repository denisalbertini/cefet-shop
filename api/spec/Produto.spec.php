...
describe('Produto', function () {
        ...
        function () {
            expect(function () {
                new Produto(
                    ...
                    new Url('https://url.com'),
                    new Cefetin(1),
                    new Promocao('abc', new Porcentagem(0.04)),
                );
        ...
        function () {
            expect(function () {
                new Produto(
                    ...
                    new Url('https://url.com'),
                    new Cefetin(1),
                    new Promocao('abc', new Porcentagem(0.21)),
                );
            })->toThrow(MensagemErro::PRODUTO_PROMOCAO);
        },
    );
    ...
    it('deveria retornar os dados instanciados corretamente', function () {
        ...
        $preco = new Cefetin(1);
        $promocao = new Promocao('abc', new Porcentagem(0.1));
    ...
    it('deveria remover promoção corretamente', function () {
        $produto = new Produto(
            ...
            new Url('https://url.com'),
            new Cefetin(1),
            new Promocao('abc', new Porcentagem(0.1)),
        );
