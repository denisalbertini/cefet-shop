...
(UUID(), 'Bermuda Turismo', 'Bermuda do curso de Turismo', 90, 270, '2024-2', 'https://placehold.co/400x500', 7990, NULL),
(UUID(), 'Pulseira Física', 'Pulseira do curso de Física', 70, 310, '2024-1', 'https://placehold.co/400x500', 1590, (SELECT id FROM promocao WHERE nome = 'Liquidação de Verão')),
(UUID(), 'Chinelo Sistemas', 'Chinelo do curso de Sistemas', 110, 390, '2023-2', 'https://placehold.co/400x500', 4990, NULL),
(UUID(), 'Moletom Engenharia', 'Moletom do curso de Engenharia', 65, 205, '2024-1', 'https://placehold.co/400x500', 8990, NULL),
(UUID(), 'Broche Turismo', 'Broche do curso de Turismo', 45, 140, '2024-2', 'https://placehold.co/400x500', 699, (SELECT id FROM promocao WHERE nome = 'Black Friday'));
